                        ...
                        <li>
                            <form method="GET" action="controllerSearch.php" class="navbar-form navbar-left">
                                <div class="form-group">
                                  <input type="text" name="search" class="form-control search" value="<?php echo $search; ?>">
                                </div>
                            </form>
                        </li>
...
?>
                                        <tr>
                                            <td>
                                                <a href="#"><img src="<?php echo "../".$row["product_image"];?>" alt="<?php echo $row["id"]; ?>" class="img-responsive" onclick="loadSearchProduct(this.alt)" width="120" height="120"></a>
                                            </td>
                                            ...
                                            <td>
                                                <center>
                                                    <button type="button" class="btn btn-success btn-lg" value="<?php echo $row["id"]; ?>" onclick="productToCart(1, this.value);">Add to cart</button>
                                                </center>
                                            </td>
                                        </tr>
<?php
