<?php
  echo $messageError;
?>
<form method="POST" enctype="multipart/form-data" action="../../controllers/admin/controllerCreateProduct.php" id="formPost" class="form-horizontal col-xs-offset-1 col-xs-10 col-sm-offset-2 col-sm-8 col-md-offset-2 col-md-8 col-lg-offset-2 col-lg-8 thumbnail">
