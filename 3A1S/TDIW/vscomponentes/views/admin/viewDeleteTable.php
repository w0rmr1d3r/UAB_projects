...
<form method="POST" id="formPost" class="form-horizontal col-xs-offset-1 col-xs-10 col-sm-offset-2 col-sm-8 col-md-offset-2 col-md-8 col-lg-offset-2 col-lg-8 thumbnail">
    <h4 class="col-xs-offset-2 col-xs-8 col-sm-offset-2 col-sm-8 col-md-offset-2 col-md-8 col-lg-offset-2 col-lg-8 text-center h4-register">Delete a product</h4>
...
?>
    ...
    <div class="form-group">
        <div class="col-xs-offset-2 col-xs-10 col-sm-offset-2 col-sm-10">
            <input type="submit" class="btn btn-success" value="Delete product" onclick="deleteOneProduct()">
        </div>
    </div>
